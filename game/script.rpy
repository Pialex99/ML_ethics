...
label deepfake:
    ...
    show friend0 happy
    friend0 "Hey, have you seen this funny video where Tom Cruise falls at the beginning ? Let me show it to you !"
    $ renpy.movie_cutscene("video/tom-cruise.webm")

    hide friend0
    show friend1 happy 
    friend1 "Oh yes I saw that, but in fact it is not real ! It is a deep fake video that has been generated by an AI !"
    hide friend1
    show friend2 happy
    friend2 "That's so cool ! We could also try to do that maybe to apply our machine learning skills ?"
    hide friend2
    show friend0 happy 
    friend0 "Yes, since the classes are prerecorded and we have videos, we can do a competition among us and train models to make deepfake videos of the teachers, it will be fun !"
