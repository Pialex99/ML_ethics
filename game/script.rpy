...
label deepfake_undisguisable :
    ...
    narrator "With all the time you have invested in it, you have noticed that it always include a ring on the right middle finger of everybody in the videos and you can't figure out why it does that."
    $ detail = "ring"
...
label deepfake_recognizable :
    ...
    menu :
        ...
        "Add a hat on everybody's head":
            $ detail = "hat"
            jump deepfake_after_detail
        "Add a earring to everybody's ear":
            $ detail = "earring"
            jump deepfake_after_detail
...
label deepfake_after_detail:
    ...
    narrator "You and your friends get together to watch the results. Most of your friends’ work is not really convincing but yours and one of your friends’ are both awesome and so you decide to vote on who should win … "

    # maybe put a Deep Fake video ? here or at the end somewhere ?

    narrator "It is very close but you win the bet !"

    narrator "Your opponent is mad at you and in an angry outburst he/she puts your work online !"
    
    narrator "You are very angry at your friend but the video is online and so nothing else can be done."

    narrator "Soon after a company contacts you with a very interesting offer to buy your program to make advertisement."
